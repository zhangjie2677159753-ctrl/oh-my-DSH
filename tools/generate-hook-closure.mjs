...
const DISPOSITIONS = {
  ...
  "comment-checker": { dshComponent: "guards/files.mjs + comment rules (fixture pending)", status: "pending-fixture", tests: null },
  "tool-output-truncator": { dshComponent: "host spill/result pruner", status: "pending-binding", tests: null },
  "question-label-truncator": { dshComponent: "question adapter", status: "pending-binding", tests: null },
  ...
  "read-image-resizer": { dshComponent: "attachment/vision adapter", status: "pending-binding", tests: null },
  "todo-description-override": { dshComponent: "task semantics", status: "pending-binding", tests: null },
  "webfetch-redirect-guard": { dshComponent: "web adapter", status: "pending-binding", tests: null },
