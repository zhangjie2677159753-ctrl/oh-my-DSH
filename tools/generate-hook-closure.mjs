...
const DISPOSITIONS = {
  ...
  "session-notification": { dshComponent: "guards/reminders.mjs", status: "contract-level", tests: "reminders.test.mjs" },
  ...
  "directory-readme-injector": { dshComponent: "guards/reminders.mjs", status: "contract-level", tests: "reminders.test.mjs" },
  "empty-task-response-detector": { dshComponent: "tasks/task.mjs + reconciler", status: "contract-level", tests: "task.test.mjs" },
  "think-mode": { dshComponent: "guards/reminders.mjs", status: "contract-level", tests: "reminders.test.mjs" },
  ...
  "keyword-detector": { dshComponent: "guards/reminders.mjs", status: "contract-level", tests: "reminders.test.mjs" },
  "agent-usage-reminder": { dshComponent: "guards/reminders.mjs", status: "contract-level", tests: "reminders.test.mjs" },
  ...
  "category-skill-reminder": { dshComponent: "guards/reminders.mjs", status: "contract-level", tests: "reminders.test.mjs" },
  ...
  "hephaestus-agents-md-injector": { dshComponent: "guards/reminders.mjs", status: "contract-level", tests: "reminders.test.mjs" },
  ...
  "bash-file-read-guard": { dshComponent: "guards/reminders.mjs", status: "contract-level", tests: "reminders.test.mjs" },
  ...
  "todo-description-override": { dshComponent: "guards/reminders.mjs", status: "contract-level", tests: "reminders.test.mjs" },
