...
| P2-1..P2-3（notification） | **live 闭环**：父会话权威通知（post-execute）+ 子会话审计（subagent/end）双落地（rc5 探针，G1-EVIDENCE 17）；下一回合 pending 注入待 prompt-section 绑定 | G1-EVIDENCE 17 + /tmp/omo-probe10-* | 2026-08-16 |
